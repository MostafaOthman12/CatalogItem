...
User1 = User(name="Robo Barista", email="tinnyTim@udacity.com",
             picture='https://pbs.twimg.com/profile_images'
                     '/2671170543/18debd694829ed78203a5a36dd364160'
                     '_400x400.png')
session.add(User1)
session.commit()
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description=" A famous duck dish from Beijing[1]"
                                 ...
                                 " The meat is prized for its"
                                 " thin, crisp skin,"
                                 " with authentic versions of"
                                 " the dish serving mostly the skin and litt"
                                 "le meat, sliced in front of"
                                 " the diners by the cook",
...
menuItem6 = MenuItem(user_id=1, name="Ramen",
                     ...
                     " fish-based broth, often flavored with soy sauce"
                     " or miso, and uses toppings such as sliced pork,"
                     " dried seaweed,"
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     description="a Vietnamese"
                     " noodle soup consisting of broth,"
...
menuItem2 = MenuItem(user_id=1,
                     ...
                     " The skin can be either thin and elastic or"
                     " thicker.",
                     price="$6.99",
                     course="Appetizer",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Stinky Tofu",
                     description="Taiwanese dish, deep"
...
menuItem4 = MenuItem(user_id=1,
                     ...
                     " a midly spiced soya,garlic sauce cooked"
                     " with fresh cilantro, celery, chilies,"
                     "ginger & green onions",
                     price="$6.95",
                     course="Appetizer",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     " sea snails, crawfish, stacked into a delicious tower",
                     price="$13.95",
                     course="Entree",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1,
                     name="Choc Full O\' Mint (Smitten\'s"
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     " of tomatoes, onions and alllll those tasty Indian"
                     "spices. Mmmm.",
                     price="$9.95",
                     course="Entree",
                     restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Morels on toast (seasonal)",
                     ...
                     " fried in butter, served on herbed toast slices",
                     price="$7.50",
                     course="Appetizer",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     ...
                     " yoghurt and seasoned with a spicy mix(chilli,"
                     " tamarind among others)"
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     " Seeds slathered with buttery chantrelle mushrooms",
                     price="$5.95",
                     course="Appetizer",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     " served hot with spicey Italian Pork Jowl (guanciale)",
                     price="$6.95",
                     course="Dessert",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     " Sandwich on a chocolate macaron with"
