...
CLIENT_ID = json.loads(
    open('/var/www/CatalogItem/client_secret.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/CatalogItem/client_secret.json', scope='')
    ...
    output += ' " style = "width: 300px; height: 300px;border-' \
              'radius:150px;-webkit-border-radius: 150px;' \
...
"""
get user ID by passing login session from it we get 
username email and pic 
"""
...
"""
get all user data by passing user id 
"""
...
def newMenuItem(restaurant_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "<script>function myFunction()" \
               ...
               " restaurant in order to add items.');}" \
               "</script><body onload='myFunction()'>"
    else:
        return render_template(
